...
using Qoollo.Impl.DbController.AsyncDbWorks.Restore;
using Qoollo.Impl.DbController.AsyncDbWorks.Support;
using Qoollo.Impl.DbController.AsyncDbWorks.Timeout;
...
namespace Qoollo.Impl.DbController.AsyncDbWorks
{
    internal class AsyncDbWorkModule:ControlModule
    {
        ...
        public AsyncDbWorkModule(DbControllerNetModule dbControllerNet, AsyncTaskModule async, DbModuleCollection db,
            ...
            QueueConfiguration queueConfiguration, ServerId local, bool isNeedRestore = false)
        {
            ...
            _initiatorRestore = new InitiatorRestoreModule(initiatorConfiguration, dbControllerNet, async);
            _transfer = new TransferRestoreModule(transferConfiguration, dbControllerNet, async, 
                db, local, queueConfiguration);
            _timeout = new TimeoutModule(dbControllerNet, async, queueConfiguration,
