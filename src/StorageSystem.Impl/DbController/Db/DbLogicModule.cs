...
namespace Qoollo.Impl.DbController.Db
{
        ...
        where TConnection : class
    {
        ...
        {
            var timer = PerfCounters.DbControllerCounters.Instance.CreateTimer.StartNew();
            ...
            if (!ret.IsError)
            {
                var metaTimer = PerfCounters.DbControllerCounters.Instance.CreateMetaDataTimer.StartNew();
        ...
        {
            var timer = PerfCounters.DbControllerCounters.Instance.ReadMetaDataTimer.StartNew();
