...
namespace Qoollo.Impl.DbController.Model
{
    internal class ControllerModel:IDisposable
    {
        ...
        public ControllerModel(ServerId local, HashMapConfiguration hashMapConfiguration)
        {
