...
{
    internal class SingleConnectionToDbController : SingleConnection<ICommonNetReceiverDbControllerForWrite>, ICommonNetReceiverDbControllerForWrite, ISingleConnection
    {
        public SingleConnectionToDbController(ServerId server, ConnectionConfiguration configuration,
        ...
        public InnerData ReadOperation(InnerData data, out RemoteResult result)
        {
            ...
            var ret = SendFunc<InnerData, ICommonNetReceiverDbControllerForWrite>(
                api =>
                {
