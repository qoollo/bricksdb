...
{
    internal class ControllerSystemModel
    {
        ...
        public ControllerSystemModel(DistributorHashConfiguration configuration, HashMapConfiguration mapConfiguration)
        {
        ...
        public List<ControllerDescription> GetDestination(InnerData ev)
        {
            _lock.EnterReadLock();
            var ret = new List<ControllerDescription>();
        ...
        public List<ControllerDescription> GetAllAvailableServers()
        {
            _lock.EnterReadLock();
            var ret = new List<ControllerDescription>(_servers.Where(x=>x.IsAvailable));            
            _lock.ExitReadLock();
            return ret;
        }
